...
Use [source-of-truth.md](source-of-truth.md) for source keys. This catalog summarizes official Unity 6.3 and Microsoft documentation; verify project-specific costs with profiling.
