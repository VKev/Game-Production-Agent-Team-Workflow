...
Use [source-of-truth.md](source-of-truth.md) for source keys. This reference targets the `com.unity.collections` version actually installed in a Unity **6000.3.21f1** project.

## Use this reference only after the package gate

Unity 6.3 lists `com.unity.collections` 2.1.4 as a released package, but the project may install another compatible version or no package at all. [U13]
