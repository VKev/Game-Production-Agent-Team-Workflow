...
- WebGL designs that depend on managed threads in Unity 6.3.
...
For Unity 6.3 WebGL, managed threads and `System.Threading`-based designs are not supported in the normal model. Prefer coroutines, Unity asynchronous operations, PlayerLoop-based UniTask operations, or platform-supported web APIs.
