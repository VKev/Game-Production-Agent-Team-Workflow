...
- [Unity project dependency manifest](https://docs.unity3d.com/ja/6000.3/Manual/upm-dependencies.html): supports resolving NuGetForUnity as a project dependency before interactive setup.
- [Unity Git dependencies](https://docs.unity3d.com/ja/6000.3/Manual/upm-git.html): official revision and `?path=` syntax used for the checker-verified NuGetForUnity tag and the later ZLinq.Unity tag.
