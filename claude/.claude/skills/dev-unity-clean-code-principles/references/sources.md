...
6. **Unity 6.3 C# compiler**
   https://docs.unity3d.com/6000.3/Documentation/Manual/CSharpCompiler.html
   Used as the authority for supported and unsupported C# features in Unity 6.3; do not hard-code a language-version assumption.

7. **Unity 6.3 script serialization**
...
9. **Unity 6.3 garbage collection best practices**
