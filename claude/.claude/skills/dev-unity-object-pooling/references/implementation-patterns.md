...
The following Unity 6.3 example keeps the raw pool private, applies spawn state before activation, supplies an overflow destroy callback, and guards self-return.
