...
This Skill therefore synthesizes the official Unity 6.3 API, Unity's GC and profiling guidance, Unity's official object-pooling tutorial, and carefully selected public Skill structure patterns.
...
Unity 2021 LTS and newer include built-in pool APIs. For Unity 6.3, `ObjectPool<T>` is the default stack-based implementation, while `LinkedPool<T>` is an alternative storage strategy. Both are not thread-safe.
...
1. Unity 6.3 `ObjectPool<T>` constructor
   - https://docs.unity.cn/6000.3/Documentation/ScriptReference/Pool.ObjectPool_1-ctor.html
   - Defines create/get/release/destroy callbacks, Editor collection checks, `defaultCapacity`, and `maxSize`.

2. Unity 6.3 `ObjectPool<T>.Release`
   - https://docs.unity3d.com/6000.3/Documentation/ScriptReference/Pool.ObjectPool_1.Release.html
...
4. Unity 6.3 `LinkedPool<T>` constructor
   - https://docs.unity3d.com/6000.3/Documentation/ScriptReference/Pool.LinkedPool_1-ctor.html
   - Documents callbacks, collection checks, and maximum inactive size for the linked implementation.

5. Unity 6.3 `IObjectPool<T>`
   - https://docs.unity3d.com/6000.3/Documentation/ScriptReference/Pool.IObjectPool_1.html
   - Defines the shared pool interface.

6. Unity 6.3 GC best practices
...
9. Unity 6.3 `ListPool<T>`
   - https://docs.unity.cn/ScriptReference/Pool.ListPool_1.html
   - Documents reusable list pooling and scoped get patterns.

10. Unity 6.3 `DictionaryPool<TKey,TValue>`
    - https://docs.unity3d.com/6000.3/Documentation/ScriptReference/Pool.DictionaryPool_2.html
    - Documents dictionary pooling.

11. Unity Memory Profiler package for 6000.3
    - https://docs.unity3d.com/6000.3/Documentation/Manual/com.unity.memoryprofiler.html
    - Provides memory snapshots and allocation analysis; package 1.0.0 is released for Unity 6.3.
...
2. `unity-csharp-scripting`
   ...
   - Useful for Unity lifecycle, cached components, and Play Mode verification. Its main version target is Unity 6, so API examples must be checked against Unity 6.3.
...
2. Unity 6.3 official Manual and Scripting API.
