...
Do not assume a Unity 6 tutorial API is available in Unity 2022.3. Preserve project-compatible syntax and packages.
...
- Update root and local `AGENTS.md` tables of contents through `unity-project-context` after project-owned folder or important-file changes.
