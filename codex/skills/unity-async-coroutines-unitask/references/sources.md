...
- Unity 2022.3 Coroutines manual:
  https://docs.unity3d.com/2022.3/Documentation/Manual/Coroutines.html
- Unity 2022.3 `MonoBehaviour` API, including `destroyCancellationToken`:
  https://docs.unity3d.com/2022.3/Documentation/ScriptReference/MonoBehaviour.html
- Unity 2022.3 `Application.exitCancellationToken`:
  https://docs.unity3d.com/2022.3/Documentation/ScriptReference/Application-exitCancellationToken.html
- Unity 2022.3 `AsyncOperation`:
  https://docs.unity3d.com/2022.3/Documentation/ScriptReference/AsyncOperation.html
- Unity 2022.3 `WaitForSecondsRealtime`:
  https://docs.unity3d.com/2022.3/Documentation/ScriptReference/WaitForSecondsRealtime.html
- Unity 2022.3 `WaitUntil`:
  https://docs.unity3d.com/2022.3/Documentation/ScriptReference/WaitUntil.html
- Unity 2022.3 `WaitForEndOfFrame`:
  https://docs.unity3d.com/2022.3/Documentation/ScriptReference/WaitForEndOfFrame.html
...
- Unity 2022.3 exposes destroy and application-exit cancellation tokens.

### Version, platform, jobs, tests, and profiling

- Unity 2022.3 C# compiler support:
  https://docs.unity3d.com/2022.3/Documentation/Manual/CSharpCompiler.html
- Unity 2022.3 .NET profile support:
  https://docs.unity3d.com/2022.3/Documentation/Manual/dotnetProfileSupport.html
- Unity 2022.3 WebGL technical limitations:
  https://docs.unity3d.com/2022.3/Documentation/Manual/webgl-technical-overview.html
- Unity 2022.3 Job System:
...
- Unity 2022.3 CPU Usage Profiler:
  https://docs.unity3d.com/2022.3/Documentation/Manual/ProfilerCPU.html
- Unity 2023.2 Await support, documenting introduction in Unity 2023.1:
  https://docs.unity3d.com/2023.2/Documentation/Manual/AwaitSupport.html

Key findings:

- Unity 2022.3 uses Roslyn with C# 9, with documented unsupported features.
- Unity 2022.3 supports .NET Standard 2.1 or the .NET Framework compatibility profile.
- Unity 2022.3 WebGL does not support the normal managed threading model.
- CPU-heavy parallel work belongs in Jobs/Burst when the workload fits.
- Unity native `Awaitable` support starts in Unity 2023.1, so it must not be used in Unity 2022.3 code.
...
- On Unity 2022.3, true end-of-frame UniTask waiting requires a `MonoBehaviour` runner.
...
The public Unity scripting skill includes basic coroutine guidance but does not cover structured Task/UniTask selection, cancellation ownership, PlayerLoop timing, single-consumption semantics, timeout behavior, or migration verification. The performance skill contributes the profile-first rule. This custom skill fills those gaps and targets version-aware Unity use rather than assuming Unity 6 APIs.
