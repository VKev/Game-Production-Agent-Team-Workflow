...
6. **Is the target WebGL?**
   - Do not design around managed thread-pool execution in Unity 2022.3 WebGL.
7. **Is Unity 2023.1 or newer?**
...
| Unity `Awaitable` | Unity 2023.1+ dependency-free Unity awaits | Typed awaitable flow | Token support depends on API | Unity model | Not available in 2022.3; fewer Task-like composition features than UniTask |
