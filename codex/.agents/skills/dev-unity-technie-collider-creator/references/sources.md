...
- [Unity MeshCollider manual](https://docs.unity3d.com/Manual/class-MeshCollider.html): runtime collider constraints and cooking context.
- [Unity Burst manual](https://docs.unity3d.com/Packages/com.unity.burst@latest): dependency/performance context for dynamic skinned generation.

Use the installed PDF and code for exact UI labels and APIs because the public site does not mirror the full manual.
