...
10. Use `unity-project-context` to update the applicable `AGENTS.md` table of contents after creating, moving, renaming, or deleting folders.
...
Do not mix `UnityEngine.Object` ownership into worker-job folders. Use `unity-jobs-burst-native-collections` for implementation and safety details.
...
- Update root and local `AGENTS.md` tables of contents through `unity-project-context`.
