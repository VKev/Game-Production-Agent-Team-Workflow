...
description: Design, implement, review, and debug Unity dependency injection with VContainer. Use when a Unity project uses jp.hadashikick.vcontainer or a task involves LifetimeScope composition, registrations, constructor or method injection, entry points, nested scopes, factories, disposal, UniTask integration, source generation, diagnostics, or migration away from service locators and global singletons.
---
