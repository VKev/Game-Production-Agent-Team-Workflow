...
Confirm the target project's Unity version and `Packages/packages-lock.json` before relying on version-sensitive behavior. The Unity engine links below target 2022.3, while the Localization links target package 1.5.

## Lightweight manager baseline

- [Resources.Load](https://docs.unity3d.com/2022.3/Documentation/ScriptReference/Resources.Load.html): load authored language tables from a `Resources` folder.
- [PlayerPrefs](https://docs.unity3d.com/2022.3/Documentation/ScriptReference/PlayerPrefs.html): persist a non-sensitive language code between sessions.
- [Application.systemLanguage](https://docs.unity3d.com/2022.3/Documentation/ScriptReference/Application-systemLanguage.html): inspect Unity's system-language value when choosing an initial locale.
