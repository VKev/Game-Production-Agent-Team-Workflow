...
Audio Mixer support and behavior can differ by platform; Unity 2022.3 documents that WebGL does not support Audio Mixers. Route WebGL requirements through an explicit fallback rather than assuming desktop mixer behavior.
